        ...
        <div className="flex justify-between h-32">
          <div className="flex items-center">
            <div className="z-50 flex-shrink-0 flex items-center">
              <a href="https://energyconsortium.org/?fbclid=IwY2xjawJF_xtleHRuA2FlbQIxMQABHYt_DuF6E500qbtveDB-xDQwsDg-6zQixKGjYWGhRVSIBuoJOrEgg6CV7Q_aem_4HMhnpmnbxj6rz2HpiQjoQ" className="ml-2 text-xl font-bold text-blue-900 ">
                <img className="HomePage-img img-fluid" src={HomePageImg} alt="HomePageImg" />
              </a>
            </div>
          </div>
